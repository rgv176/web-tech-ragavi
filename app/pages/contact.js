      ...
      <form className="[&_span]:block grid gap-3" onSubmit={onSubmit}>
        <div>
          <label>
            ...
            <input type="text" name="firstname" className="dark:text-black" />
          </label>
        </div>
        <div>
          <label>
            <span>Last name</span>
            <input type="text" name="lastname" className="dark:text-black" />
          </label>
        </div>
        <div>
          <label>
            <span>Email</span>
            <input type="text" name="email" className="dark:text-black" />
          </label>
        </div>
        <div>
          <label>
            <span>Message</span>
            <textarea name="message" className="dark:text-black" />
          </label>
        </div>
        <div>
